...
class Fiber_num_distribution():
    ...
    def fib_svf_dis(self):
        ...
        fib_dia = [465, 435, 405, 375, 345, 315, 285, 255, 225, 195, 165, 135, 105, 75, 45, 15]
        if Fib_zone == 2:
            fib_dia_svf = [0.0230, 0.0000, 0.0000, 0.0000, 0.0000, 0.0105, 0.0043, 0.0725, 0.1533, 0.3495, 0.3153, 0.0552, 0.0053, 0.0054, 0.0056, 0.0001]   #张鑫的全部数据
        leng = len(fib_dia)
        l = 0
        while l < leng:
...
bead_lh_ratio = 2
bead_hf_ratio = 2
SVF_control_factor_Fiber = 0.1
SVF_control_factor_Bead = 0.1
Fib_num_set = 47
Bead_num_set = 360
Fib_zone = 2
Bead_zone = 2
